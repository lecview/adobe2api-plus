...
const defaults: FormState = {
  ...
  generateTimeoutSeconds: 300, videoGenerateTimeoutSeconds: 600, refreshIntervalHours: 15, sherlockRefreshMinutes: 5, sherlockAutoRefreshEnabled: true, minCreditsThreshold: 0, returnOriginalUrl: false, workerConcurrency: 1, retryEnabled: true, retryMaxAttempts: 3, retryBackoffSeconds: 1,
  retryOnStatusCodes: "429,451,500,502,503,504", retryOnErrorTypes: "timeout,connection,proxy", tokenRotationStrategy: "round_robin",
  batchConcurrency: 5, creditsRefreshConcurrency: 1, accountMaxConcurrency: 1, generatedMaxSizeMb: 1024, generatedPruneSizeMb: 200, adminUsername: "admin",
};
